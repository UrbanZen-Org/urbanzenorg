jQuery(function( $ ){
	...
	'</ul>' +
	'<p>... and <strong>22 StudioPress Themes</strong> and <strong>11 partner plugins</strong> are ready for you to use.</p>' +
	...
	'<ul>' +
	'<li><a href="/wp-admin/admin.php?page=sp-themes"><strong>Choose one of the included themes</strong></a></li>' +
