<?php /*
  Template Name: UZIT Donate with Mandrill
 */ ?>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    */
    ...
    require_once 'auth_net/config-sandbox.php';
    ...
    if ($METHOD_TO_USE == "AIM") {
        ...
        if ($response->approved) {
			...
			$mandrill = new Mandrill('sokSRWNSdFvoNmGx6PIvmg');
			$template_name = 'uzit-letterhead-black-copy-02';
			$sen_name = "Urban Zen Foundation";
			$sen_email = "support@urbanzen.org";
			$rec_name = "";
			$rec_email = "";
			$email_sub = "Thank you for your support";
			$message = array();
			$to = array();
			$template_content = array(
			    ...
			    array(
			        'name' => 'footer',
			        'content' => 'Copyright test.')

			);
			if (isset($_POST['x_first_name'])) {
			$rec_name = $_POST['x_first_name'];
			}
			if (isset($_POST['x_email'])) {
			$rec_email = $_POST['x_email'];
			}
	...
	jQuery(function($)  
		{
		    ...
		    {
		        var email = $("#EMAIL_ADDRESS").val(); // get email field value
		        var first_name = $("#FIRST_NAME").val(); // get name field value
		        ...
		        $.ajax(
		        {
		            ...
		            data: {
		                "key": "sokSRWNSdFvoNmGx6PIvmg",
		                "message": {
		                    "from_email": "support@urbanzen.org",
...
<div id="Donate" class="payment" style="background:#fff;">
    <div class="inner-content container clearfix">
        ...
        <form action="" method="POST" id="donate-form" class="billing-form clearfix">
            ...
            <div class="form-container">
                <table class="top-payment-info">
                    <tr>
                        ...
                        <td>
                            <img src="http://uzit.urbanzen.org/wp-content/uploads/2014/02/visa.jpg" style="width:80%"/>
                        </td>
                    </tr>
                    <tr>
						 ...
						 <tr>
	                            <td colspan="4">
	                                ...
	                                <select name="x_donate_dest">
										<option value="Urban Zen Foundation">Hurricane Matthew Fund</option>
