 ...
 *
   Template Name:  Home Page Apple Event - slideshow
 *
 */
?>
<?php get_header(); ?>
			...
			<div class="container-fluid">
				<ul class="bxslider">
					<li>
						...
						<img src="/wp-content/uploads/2017/05/d_hp_slider_1_apple_b.jpg" class="mobile_hidden" />
						<img src="/wp-content/uploads/2017/05/m_hp_slider_1_Apple-Awards.jpg" class="desktop_hidden" />
					</li>
					<li>
						<div class="centerContent centerBanner">
							<h2>PRESERVATION OF CULTURE</h2>
							<h1>HAITI ARTISAN PROJECT</h1>
							<br>
							<a id="link" href="/our-initiatives/haiti-artisan-project/" class="outline-yellow-button">LEARN MORE</a>
						</div>
						<img src="/wp-content/uploads/2017/05/d_hp_slider_2_Haiti-Artisan_ss_update.jpg" class="mobile_hidden" />
						<img src="/wp-content/uploads/2017/05/m_hp_slider_2_Haiti-Artisan_ss_update.jpg" class="desktop_hidden" />
					</li>
				  	<li>
				  		<div class="centerContent centerBanner">
							<h2>WELL-BEING</h2>
				  		...
				  		<img src="/wp-content/uploads/2017/05/d_hp_slider_3_UZIT_new.jpg" class="mobile_hidden" />
				  		<img src="/wp-content/uploads/2017/05/m_hp_slider_3_UZIT_new.jpg" class="desktop_hidden" />
				  	</li>
				  	<li>
				  		<div class="centerContent centerBanner">
							<h2>EDUCATION</h2>
				  		...
				  		<img src="/wp-content/uploads/2017/05/d_hp_slider_4_Children_ss_update.jpg" class="mobile_hidden" />
				  		<img src="/wp-content/uploads/2017/05/m_hp_slider_4_children_ss_update.jpg" class="desktop_hidden" />
				  	</li>								  									                                      
		        </ul>
