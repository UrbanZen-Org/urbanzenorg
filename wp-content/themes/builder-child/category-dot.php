...
<div id="content">
	...
	<div id="inner-content" class="wrap clearfix">
      ...
      <h1 class="page-title h2 text-center"><span>Blogs From Haiti</h1>
        ...
        <ul class="media-list">
          <li class="media">
            ...
            <div class="media-body">
			  <h5 class="page-title" itemprop="headline"><a href="<?php the_permalink();?>" title="<?php the_title();?>"><?php $s = substr(the_title('','',FALSE),0,25); ?>
			  <?php echo $s; if (strlen($s) >21){ echo '…'; } ?></a></h5>
              <?php the_excerpt(); ?>
            </div>
          </li>
        </ul>
