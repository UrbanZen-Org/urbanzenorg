...
<div class="col-md-3">
  ...
  <ul id="filters" class="inline clearfix hidden-sm" style="padding-left:0;">
    <li>
  ...
  <div>
    <h4 style="color:#C28742;">
    Shop
    </h4>
    <p id="callout" >
      A selection of our designs are available to purchase online. Visit our e-store.
    </p>
    </div>
</div>
<?php if (!defined ('ABSPATH')) die ('No direct access allowed'); ?><?php if (!empty ($gallery)) : ?>

<div class="col-md-9 photos clearfix"  id="<?php echo $gallery-> anchor; ?>">
        <?php
        ...
        <?php foreach ( $images as $image ) : ?>    
                ...
                <div class="photo col-lg-3 col-sm-4 col-xs-6  <?php echo $tag_string; ?><?php echo $image->ngg_custom_fields['Image Shape']; ?>">
