...
?>
<?php/**** TEST ****/ ?>
    <script src="<?php bloginfo('stylesheet_directory'); ?>/library/js/zoom/uz_zoom2.js" type="text/javascript"></script>
<style type="text/css">
...
<?php if (!defined ('ABSPATH')) die ('No direct access allowed'); ?><?php if (!empty ($gallery)) : ?>
  ...
  <div class="row col-md-12">
     <h1 class="collection-title pull-left" style="padding-left:15px"><?php the_title(); ?></h1><p class="collection-note pull-right">INQUIRE | <a href="mailto:lisa@URBANZEN.COM">Lisa@urbanzen.com</a></p>
   </div>
