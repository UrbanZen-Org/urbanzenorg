...
**/
?>
<script src="<?php bloginfo('stylesheet_directory'); ?>/library/js/zoom/uz_zoom.js" type="text/javascript"></script>
...
<?php if (!defined ('ABSPATH')) die ('No direct access allowed'); ?><?php if (!empty ($gallery)) : ?>
  ...
  <div class="row col-md-12">
     <h1 class="collection-title pull-left" style="padding-left:15px"><?php the_title(); ?></h1><p class="collection-note pull-right">INQUIRE | <a href="mailto:705@URBANZEN.COM">New York</a>: 212 206 3999, <a href="mailto:uzsh@urbanzen.com">Sag Harbor</a>: 631 725 6176, <a href="mailto:aspen@urbanzen.com">Aspen</a>: 970 710 2961</p>
   </div>
<?php /* ?><div class="col-md-12 photos clearfix" id="isotopegallery" id="<?php echo $gallery-> anchor; ?>"> <?php */ ?>
<div class="col-md-12 photos clearfix" id="<?php echo $gallery-> anchor; ?>">
        ...
        <?php foreach ( $images as $image ) : ?>    
                ...
                <div class="photo col-lg-3 col-md-3 col-sm-4 col-xs-12 <?php echo $tag_string; ?><?php echo $image->ngg_custom_fields['Image Shape']; ?>">
